...
const operators = {
    ...
    'マゼラン': new Set(['上級エリート', '遠距離', '補助タイプ', '火力', '支援', '減速']),
    'モスティマ': new Set(['上級エリート', '遠距離', '術師タイプ', '範囲攻撃', '支援', '牽制']),
    ...
    'イグゼキュター': new Set(['エリート', '遠距離', '狙撃タイプ', '範囲攻撃']),
    'ナイトメア': new Set([
        'エリート',
        '遠距離',
        '術師タイプ',
    ...
    'アステシア': new Set(['エリート', '近距離', '前衛タイプ', '火力', '防御']),
    'ヴァルカン': new Set([
        'エリート',
        '近距離',
        '重装タイプ',
    ...
    'グラウコス': new Set(['エリート', '遠距離', '補助タイプ', '減速', '牽制']),
    ...
    'テンニンカ': new Set(['近距離', '先鋒タイプ', '治療', 'COST回復']),
